...
public class ChartEvaluasiActivity extends AppCompatActivity {
    Context ctx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chart_evaluasi);
...
//        arrayList = helper.getData("select * from hasil where nama = 'evaluasi'");
...
//        ds.setValueTextSize(16f);
        ...
        lds = new LineDataSet(helper.getLine("select * from hasil where nama = 'evaluasi'"), "Hasil");
        ...
        bar.setData(ld);
        bar.invalidate();
        getSupportActionBar().setTitle("Grafik Evaluasi");
    }
}