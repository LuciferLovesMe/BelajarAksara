...
public class ChartAngkaActivity extends AppCompatActivity {
    Context ctx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chart_angka);
        ...
        arrayList = helper.getData("select * from hasil where nama = 'angka'");
...
//        ds.setValueTextSize(16f);
        ...
        lds = new LineDataSet(helper.getLine("select * from hasil where nama = 'angka'"), "Hasil");
        ...
        bar.setData(ld);
        bar.invalidate();
        getSupportActionBar().setTitle("Grafik Angka");
    }
}