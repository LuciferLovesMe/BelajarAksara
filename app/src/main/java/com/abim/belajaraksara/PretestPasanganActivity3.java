...
public class PretestPasanganActivity3 extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pretest_pasangan3);

        ctx = this;
        c[0] = PretestPasanganActivity9.class;
        c[1] = PretestPasanganActivity2.class;
        c[2] = PretestPasanganActivity1.class;
