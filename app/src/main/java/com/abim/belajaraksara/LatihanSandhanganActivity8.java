...
public class LatihanSandhanganActivity8 extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_sandhangan8);
        ...
        c[1] = LatihanSandhanganActivity2.class;
        ...
        c[7] = LatihanSandhanganActivity9.class;
    }
