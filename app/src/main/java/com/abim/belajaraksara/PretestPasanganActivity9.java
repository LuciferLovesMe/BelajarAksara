...
public class PretestPasanganActivity9 extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pretest_pasangan9);

        ctx = this;
        c[0] = PretestPasanganActivity1.class;
