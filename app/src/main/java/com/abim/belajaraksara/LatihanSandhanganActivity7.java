...
public class LatihanSandhanganActivity7 extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_sandhangan7);
        ...
        c[6] = LatihanSandhanganActivity9.class;
