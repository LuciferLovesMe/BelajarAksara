...
public class ChartSwaraActivity extends AppCompatActivity {
    Context ctx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chart_swara);
...
//        arrayList = helper.getData("select * from hasil where nama = 'swara'");
...
//        ds.setValueTextSize(16f);
        ...
        lds = new LineDataSet(helper.getLine("select * from hasil where nama = 'swara'"), "Hasil");
        ...
        bar.setData(ld);
        bar.invalidate();
        getSupportActionBar().setTitle("Grafik Swara");
    }
}