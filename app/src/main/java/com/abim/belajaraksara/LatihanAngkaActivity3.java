...
public class LatihanAngkaActivity3 extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_angka3);
        ...
        c[2] = LatihanAngkaActivity1.class;
                    ...
                    if (getSharedPreferences(key, MODE_PRIVATE).getInt("count", 0) < 10){
                        ...
                        dialog.setButton(DialogInterface.BUTTON_NEUTRAL, "Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                db.execSQL("insert into hasil values(null, 'angka', '"+String.valueOf(n)+"');");
                                startActivity(new Intent(getApplicationContext(), AngkaActivity.class));
                            }
                        });
                        dialog.show();
