...
public class LatihanDasar1Activity extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[9];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_dasar1);

        ctx = this;
        l = new LatihanDasar(ctx);
        count = l.getCount();

        c[0] = LatihanDasarActivity.class;
