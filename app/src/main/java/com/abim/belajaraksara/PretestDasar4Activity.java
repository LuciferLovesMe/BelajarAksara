...
public class PretestDasar4Activity extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pretest_dasar4);
        ...
        c[3] = PretestDasar1Activity.class;
                    ...
                    if (getSharedPreferences(key, MODE_PRIVATE).getInt("count", 0) < 10){
                        ...
                        dialog.setButton(DialogInterface.BUTTON_NEUTRAL, "Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                db.execSQL("insert into hasil values(null, 'dasar', '"+String.valueOf(n)+"');");
                                startActivity(new Intent(getApplicationContext(), DasarActivity.class));
                            }
                        });
                        dialog.show();
