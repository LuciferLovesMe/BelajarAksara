...
public class LatihanSandhanganActivity5 extends AppCompatActivity implements View.OnClickListener {
    Context ctx;
    Class[] c = new Class[8];
    Random r = new Random();
    AlertDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_sandhangan5);
        ...
        c[4] = LatihanSandhanganActivity9.class;
